// src/features/onboarding/components/WelcomeModal.tsx
...
const WelcomeModal: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Directly trigger the interactive tutorial
        ...
        <div className="fixed inset-0 bg-background/90 backdrop-blur-lg z-[200] flex items-center justify-center p-4">
            <div className="w-full max-w-2xl text-center">
                ...
                <p className="text-slate-400 mt-6 max-w-xl mx-auto">
                    You've been granted <strong className="text-amber-300">100 complimentary AI Credits</strong> to explore the platform. To earn a <strong className="text-amber-300">bonus of 25 credits</strong>, complete your first guided mission: create a project, use an AI tool, and save your progress. First, let's set up your profile.
                </p>
